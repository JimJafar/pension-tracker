...
import { Pension, Contribution, Holding } from '../types/pension';
...
const ManagePensionPage: React.FC = () => {
  ...
  if (!pension) return <Layout><div style={styles.error}>Pension not found</div></Layout>;
      ...
      <div style={styles.container}>
        ...
        <div style={styles.section}>
          ...
          <div style={styles.details}>
            ...
            <p><strong>Contribution Type:</strong> {pension.contribution_type}</p>
            {pension.monthly_amount && <p><strong>Monthly Amount:</strong> £{pension.monthly_amount}</p>}
            {pension.day_of_month && <p><strong>Day of Month:</strong> {pension.day_of_month}</p>}
          </div>
          ...
          {pension.contribution_type === 'manual' && (
            <form onSubmit={handleAddContribution} style={styles.form}>
              ...
              <input
                ...
                required
              />
              <button type="submit" style={styles.addButton}>Add Contribution</button>
            </form>
          )}
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {contributions.map((contrib) => (
                  <tr key={contrib.id}>
                    <td style={styles.td}>{new Date(contrib.contribution_date).toLocaleDateString()}</td>
          ...
          <div style={styles.section}>
            ...
            <form onSubmit={handleAddHolding} style={styles.form}>
              ...
              <input
                ...
                required
              />
              <button type="submit" style={styles.addButton}>Add Holding</button>
            </form>
