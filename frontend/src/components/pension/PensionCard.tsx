...
import { PensionWithTotals, HoldingWithPrice } from '../../types/pension';
    ...
    <div style={styles.card}>
      <div style={styles.header}>
        ...
        <div style={styles.badges}>
          ...
          <span style={styles.badge}>
            {pension.contribution_type === 'regular_fixed' ? 'Regular' : 'Manual'}
          </span>
        </div>
      </div>
      ...
      <div style={styles.totals}>
        <div style={styles.totalItem}>
          ...
          <span style={styles.totalValue}>{formatCurrency(pension.total_contributions)}</span>
        </div>
        <div style={styles.totalItem}>
          <span style={styles.totalLabel}>Current Value:</span>
          <span style={styles.totalValue}>{formatCurrency(pension.current_value)}</span>
        </div>
      </div>
